class TestIndeksertListe {
    ...
    public static void main (String[] arg) {
		...
		System.out.println("LEGG TIL 101: ");
		k.leggTil(0, 101);
		System.out.println("LEGG TIL 102: ");
		k.leggTil(102);
		System.out.println("LEGG TIL 103: ");
		k.leggTil(0, 103);
		System.out.println("LEGG TIL 104: ");
		k.leggTil(3, 104);
		System.out.println("LEGG TIL 105: ");
		k.leggTil(3, 105);
		...
		ks.leggTil("Alfa");
		//System.out.println("ks.toString(): " + ks.toString()); // E
		ks.leggTil(1, "Omega");
		//System.out.println("ks.toString(): " + ks.toString());
